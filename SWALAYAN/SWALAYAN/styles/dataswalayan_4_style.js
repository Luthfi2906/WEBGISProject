...
var style_dataswalayan_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("NAMA SWALAYAN/SUPERMARKET") !== null) {
        labelText = String(feature.get("NAMA SWALAYAN/SUPERMARKET"));
    }
